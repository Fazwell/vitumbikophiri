        ...
        <div className='contact__contect'>
           ...
           <div className='contact__info'>
            <div data-aos="flip-up" className='contact__card'>
                ...
                <span className='contact__card-data'>mwangufaz@gmail.com</span>

            </div>
            <div data-aos="flip-up" className='contact__card'>
                <i className='bx bxl-whatsapp contact__card-icon'></i>
                <h3 className='contact__card-title'>Whatsapp</h3>
                <span className='contact__card-data'>(+265) 990 775 581</span>

               
            </div>
            <div data-aos="flip-up" className='contact__card'>
                <i className='bx bxl-skype contact__card-icon'></i>
                <h3 className='contact__card-title'>Skype Id</h3>
                <span className='contact__card-data'>live:.cid.2cc64578ff0b2af7</span>
            </div>
           </div>
        </div>
